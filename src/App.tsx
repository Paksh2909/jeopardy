  ...
  topics: [
    ...
    },
    {
      ...
      questions: [
        ...
        { id: 'hen-2', text: 'What is Henna\'s favorite cuisine?', answer: 'Italian/Asian', difficulty: 2, points: 200, timerSeconds: null, status: QuestionStatus.AVAILABLE },
        { id: 'hen-3', text: 'What city/country does Henna dream of visiting for her honeymoon?', answer: 'Santorini, Greece', difficulty: 3, points: 300, timerSeconds: null, status: QuestionStatus.AVAILABLE },
        { id: 'hen-4', text: 'What is Henna\'s Hogwarts house?', answer: 'Hufflepuff', difficulty: 4, points: 400, timerSeconds: null, status: QuestionStatus.AVAILABLE },
        { id: 'hen-5', text: 'What is the one thing Henna cannot sleep without?', answer: 'Her shawl (Bonus: Shawl the Paul)', difficulty: 5, points: 500, timerSeconds: null, status: QuestionStatus.AVAILABLE },
      ],
    },
  ],
  teams: [
