...
const SAMPLE_CONFIG: GameConfig = {
  ...
  topics: [
    ...
    },
    {
      ...
      name: 'Geography',
      questions: [
        { id: 'geo-1', text: 'What is the smallest country in the world by area?', answer: 'Vatican City', difficulty: 1, points: 100, timerSeconds: null, status: QuestionStatus.AVAILABLE },
        { id: 'geo-2', text: 'What is the capital of Australia?', answer: 'Canberra', difficulty: 2, points: 200, timerSeconds: null, status: QuestionStatus.AVAILABLE },
        { id: 'geo-3', text: 'Which is the longest river in the world?', answer: 'Nile', difficulty: 3, points: 300, timerSeconds: null, status: QuestionStatus.AVAILABLE },
        { id: 'geo-4', text: 'Which country has the most natural lakes?', answer: 'Canada', difficulty: 4, points: 400, timerSeconds: null, status: QuestionStatus.AVAILABLE },
